...
Original file is located at
    https://colab.research.google.com/drive/1wfOAvBAbU6j8GIk_NykWeiiDxFJTkorN
...
!pip install pandas numpy scikit-learn pickle-mixin
...
# ================= Prediction Function =================
def predict_medicine(symptoms_input):
...
iface = gr.Interface(
    ...
    outputs=gr.Textbox(
        lines=30,          # makes the output box taller
        max_lines=100,     # allows scrolling if output is very long
        placeholder="Your diagnosis and recommendations will appear here"
    ),
    title="Personalized Medical Recommendation System",
    description="Enter your symptoms separated by commas, e.g., itching, skin_rash, nodal_skin_eruptions"
)
